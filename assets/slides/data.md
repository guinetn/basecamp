...
## schema
Collection of database objects including tables, views, triggers, stored procedures, indexes, types, interfaces, enums, unions... (make up your application data model)
...
----
download.md(assets/slides/data/sqlserver.md)
----
download.md(assets/slides/data/oracle.md)
----
download.md(assets/slides/data/sqlite.md)
----
