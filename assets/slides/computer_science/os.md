# OS
	...
	.								 _______ keyboards, mice, disk drives, printers, network adapters, display devices
									/
	* Hardware: memory, CPU, ALU, I/O devices, peripheral devices, storage devices
	* OS: manager for (sharing) hardware resources
		Drivers that interact with the kernel
	* system program: compilers, loaders, editors, 
